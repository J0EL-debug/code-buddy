...
export class ProjectsController {
  ...
  @Post()
  @ApiOperation({ summary: 'Create project', description: 'Register a new GitHub repository for code review' })
  @ApiResponse({ status: 201, description: 'Project created successfully' })
  @ApiResponse({ status: 409, description: 'Project with same GitHub repo ID already exists' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
