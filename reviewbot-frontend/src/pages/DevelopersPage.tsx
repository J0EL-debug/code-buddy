...
const getRankColor = (rank: number) => {
  ...
  if (rank === 2) return 'text-muted-foreground dark:text-muted-foreground';
    ...
    return (
      <div className="py-6">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
          <h1 className="text-title-lg font-semibold text-foreground dark:text-primary-foreground">Developer Leaderboard</h1>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
          <div className="mt-6 space-y-4">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="h-32 animate-pulse rounded-xl border border-border bg-secondary dark:border-gray-800 dark:bg-gray-800"
              />
            ))}
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="rounded-lg border border-border bg-card px-3 py-2 text-sm dark:border-gray-700 dark:bg-gray-800"
            />
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
        {developers.length === 0 ? (
          <div className="mt-6 rounded-xl border border-border bg-card p-12 text-center dark:border-gray-800 dark:bg-gray-dark">
            ...
            <h3 className="mt-2 text-sm font-semibold text-foreground dark:text-primary-foreground">No developers</h3>
          ...
          <div className="mt-6 space-y-4">
            {developers.filter((d) => !searchTerm.trim() || d.username.toLowerCase().includes(searchTerm.trim().toLowerCase())).map((developer, index) => {
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex h-14 w-14 flex-shrink-0 items-center justify-center overflow-hidden rounded-full bg-secondary dark:bg-gray-800">
                      {developer.avatarUrl ? (
                        <img
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2">
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-muted-foreground dark:text-muted-foreground">@{developer.username}</p>
                        </div>
                      ...
                      <div className="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-4">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="text-lg font-semibold text-foreground dark:text-primary-foreground">{developer.totalReviews}</p>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="text-lg font-semibold text-foreground dark:text-primary-foreground">{developer.totalIssues}</p>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="text-lg font-semibold text-foreground dark:text-primary-foreground">{developer.totalSuggestions}</p>
                            <p className="text-xs text-muted-foreground dark:text-muted-foreground">Suggestions</p>
                          </div>
                        </div>
                      </div>
